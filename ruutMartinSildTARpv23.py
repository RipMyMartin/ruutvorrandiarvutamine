...
def graafik():
    try:
        ...
        plt.grid(True)
        plt.show()
        text = f"Вершина параболлы: ({x0:.2f}, {y0:.2f})"
    except ValueError:
...
root = Tk()
root.geometry("1100x350")
root.iconbitmap('martinsild.ico')
